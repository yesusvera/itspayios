...
public final class Categorias: NSCoding {
  ...
  public required init(json: JSON) {
    idCategoria = json[SerializationKeys.idCategoria].int
  ...
  public func dictionaryRepresentation() -> [String: Any] {
    ...
    if let value = idCategoria { dictionary[SerializationKeys.idCategoria] = value }
  ...
  required public init(coder aDecoder: NSCoder) {
    self.idCategoria = aDecoder.decodeObject(forKey: SerializationKeys.idCategoria) as? Int
  ...
  public func encode(with aCoder: NSCoder) {
    aCoder.encode(idCategoria, forKey: SerializationKeys.idCategoria)
